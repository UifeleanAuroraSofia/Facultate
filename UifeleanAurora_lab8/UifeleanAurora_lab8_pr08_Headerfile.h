...
public:
	...
	friend Fractie adunare(Fractie);
	friend Fractie scadere(Fractie);
	friend Fractie inmultire(Fractie);
	friend Fractie impartire(Fractie);
	/*~Fractie() {
...
Fractie adunare(Fractie obj1, Fractie obj2) {
	Fractie l;
...
Fractie scadere(Fractie obj1, Fractie obj2) {
	Fractie l;
	int db = cmmmc(obj1.getB(), obj2.getB());
	int dbl = db;
	int aux = db;
...
Fractie inmultire(Fractie obj1, Fractie obj2) {
	Fractie l;
	l.setA(obj1.getA() * obj2.getA());
	l.setB(obj1.getB() * obj2.getB());
	return l;
}
Fractie impartire(Fractie obj1, Fractie obj2) {
	Fractie l;
